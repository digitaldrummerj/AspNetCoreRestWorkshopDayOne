...
namespace AspNetCoreWorkshop.Api
{
        ...
        where TRequest : IRequest<TResponse>
    {
        ...
        public async Task<TResponse> Handle(TRequest request, CancellationToken cancellationToken)
        {
            ...
            return await OnHandleAsync(request, cancellationToken).ConfigureAwait(false);
        }

        protected abstract Task<TResponse> OnHandleAsync(TRequest message, CancellationToken cancellationToken);
    }
}